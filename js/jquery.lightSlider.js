                ...
                refresh.createPager = function () {
                    ...
                    for (i = 0; i < maxSlide; i++) {
                        ...
                        if (settings.gallery === true) {
                            pagers += '<li style="float:left;width:' + settings.thumbWidth + 'px;margin-right:' + settings.thumbMargin + 'px"><a href="javascript:void(0)"><img src="' + thumb + '" /> </a> <span>图片'+(i+1)+'.jpg</span> </li>';
                        } else {
                    ...
                    if (settings.gallery === true) {
                        // pagerWidth = i * (settings.thumbMargin + settings.thumbWidth + 20);
                        pagerWidth = i * (100 + 23);
